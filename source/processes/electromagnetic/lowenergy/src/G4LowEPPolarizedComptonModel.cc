...
G4PhysicsFreeVector* G4LowEPPolarizedComptonModel::data[] = {nullptr};
G4ShellData*       G4LowEPPolarizedComptonModel::shellData = nullptr;
G4DopplerProfile*  G4LowEPPolarizedComptonModel::profileData = nullptr;
