...
//
//
// GEANT4 physics class: G4ChipsPionMinusInelasticXS -- header file
...
#ifndef G4ChipsPionMinusInelasticXS_h
#define G4ChipsPionMinusInelasticXS_h 1
...
class G4ChipsPionMinusInelasticXS :  public G4VCrossSectionDataSet
{
public:
