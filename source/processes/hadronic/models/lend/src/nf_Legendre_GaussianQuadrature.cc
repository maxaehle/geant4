...
static G4double sqrt_inv3 = 0.57735026918962576451;        /* sqrt( 1. / 3. ); */

#define n_3 3
static G4double weights_3[(n_3 + 1)/2] = { 8. / 9., 5. / 9. };
static G4double xis_3[(n_3 + 1)/2] = { 0., 0.77459666924148337704 };

#define n_4 4
static G4double weights_4[(n_4 + 1)/2] = { 0.65214515486254614263, 0.34785484513745385737 };
static G4double xis_4[(n_4 + 1)/2] = { 0.33998104358485626480, 0.86113631159405257522 };

#define n_5 5
static G4double weights_5[(n_5 + 1)/2] = { 0.568888888888889, 0.478628670499366, 0.236926885056189 };
static G4double xis_5[(n_5 + 1)/2] = { 0.0, 0.538469310105683, 0.906179845938664 };

#define n_10 10
static G4double weights_10[(n_10 + 1)/2] = { 0.295524224714752870, 0.269266719309996355, 0.219086362515982044, 0.149451349150580593, 0.066671344308688138 };
static G4double xis_10[(n_10 + 1)/2] = { 0.148874338981631211, 0.433395394129247191, 0.679409568299024406, 0.865063366688984511, 0.973906528517171720 };

#define n_20 20
static G4double weights_20[(n_20 + 1)/2] = { 
...
static G4double xis_20[(n_20 + 1)/2] = { 
...
#define n_40 40
static G4double weights_40[(n_40 + 1)/2] = {
...
static G4double xis_40[(n_40 + 1)/2] = { 
