...
*   Functions:
*
*   Note that arguments of those functions must be G4doubled, namely 1/2 is 1, etc.
*
...
============================================================
*/
G4double  nf_amc_factorial( int n ) {
/*
...
============================================================
*/
G4double nf_amc_wigner_3j( int j1, int j2, int j3, int j4, int j5, int j6 ) {
/*
*       Wigner's 3J symbol (similar to Clebsh-Gordan)
*           = / j1 j2 j3 \
*             \ j4 j5 j6 /
...
============================================================
*/
G4double nf_amc_wigner_6j( int j1, int j2, int j3, int j4, int j5, int j6 ) {
/*
*       Wigner's 6J symbol (similar to Racah)
*               = { j1 j2 j3 }
*                 { j4 j5 j6 }
...
============================================================
*/
static G4double w6j0( int i, int *x ) {
    ...
    return( 1.0 / std::sqrt( (G4double) ( ( x[0] + 1 ) * ( x[3] + 1 ) ) ) * ( ( ( x[0] + x[3] + x[5] ) / 2 ) % 2 != 0 ? -1 : 1 ) );
}
/*
============================================================
*/
static G4double w6j1( int *x ) {
...
============================================================
*/
G4double nf_amc_wigner_9j( int j1, int j2, int j3, int j4, int j5, int j6, int j7, int j8, int j9 ) {
/*
*       Wigner's 9J symbol
*             / j1 j2 j3 \
*           = | j4 j5 j6 |
...
============================================================
*/
G4double nf_amc_racah( int j1, int j2, int l2, int l1, int j3, int l3 ) {
/*
...
*/
/*
static G4double triangle( int a, int b, int c ) {
...
============================================================
*/
G4double nf_amc_clebsh_gordan( int j1, int j2, int m1, int m2, int j3 ) {
/*
*       Clebsh-Gordan coefficient 
*           = <j1,j2,m1,m2|j3,m1+m2>
*           = (-)^(j1-j2+m1+m2) * std::sqrt(2*j3+1) * / j1 j2   j3   \
...
*/
    ...
    if ( j3 == 0 ){
        if ( j1 == j2 ) cg = ( 1.0 / std::sqrt( (G4double)j1 + 1.0 ) * ( ( y1 % 2 == 0 ) ? -1:1 ) );
    }
    else if ( (j1 == 0 || j2 == 0 ) ){
        if ( ( j1 + j2 ) == j3 ) cg = 1.0;
    }
...
============================================================
*/
static G4double cg1( int x1, int x2, int x3 ) {
...
============================================================
*/
static G4double cg2( int k, int q0, int z1, int z2, int w1, int w2, int w3, int mm ) {
...
============================================================
*/
static G4double cg3( int x1, int x2, int x3, int y1, int y2, int y3 ) {
...
============================================================
*/
G4double nf_amc_z_coefficient( int l1, int j1, int l2, int j2, int s, int ll ) {
/*
*       Biedenharn's Z-coefficient coefficient
*           =  Z(l1  j1  l2  j2 | S L )
*/
    G4double z, clebsh_gordan = nf_amc_clebsh_gordan( l1, l2, 0, 0, ll ), racah = nf_amc_racah( l1, j1, l2, j2, s, ll );
...
============================================================
*/
G4double nf_amc_zbar_coefficient( int l1, int j1, int l2, int j2, int s, int ll ) {
/*
...
*/
    G4double zbar, clebsh_gordan = nf_amc_clebsh_gordan( l1, l2, 0, 0, ll ), racah = nf_amc_racah( l1, j1, l2, j2, s, ll );
...
============================================================
*/
G4double nf_amc_reduced_matrix_element( int lt, int st, int jt, int l0, int j0, int l1, int j1 ) {
/*
*       Reduced Matrix Element for Tensor Operator
*           = < l1j1 || T(YL,sigma_S)J || l0j0 >
*
...
*/
    int    llt;
    G4double x1, x2, x3, reduced_mat, clebsh_gordan;
