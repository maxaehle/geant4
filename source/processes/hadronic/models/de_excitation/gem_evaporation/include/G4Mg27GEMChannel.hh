...
private:
  const G4Mg27GEMChannel & operator=(const G4Mg27GEMChannel & right) = delete;  
  G4Mg27GEMChannel(const G4Mg27GEMChannel & right) = delete;
  G4bool operator==(const G4Mg27GEMChannel & right) const = delete;
  G4bool operator!=(const G4Mg27GEMChannel & right) const = delete;
