...
private:
  const G4N15GEMChannel & operator=(const G4N15GEMChannel & right) = delete;  
  G4N15GEMChannel(const G4N15GEMChannel & right) = delete;
  G4bool operator==(const G4N15GEMChannel & right) const = delete;
  G4bool operator!=(const G4N15GEMChannel & right) const = delete;
