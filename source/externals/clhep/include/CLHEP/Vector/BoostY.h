...
public:
  ...
  // Copy and move assignment operators.
         ...
         HepBoostY & set (G4double beta);
  inline HepBoostY       (G4double beta);
  ...
  inline  G4double distance2( const HepBoostY & b ) const;
  ...
  inline G4double howNear(   const HepBoostY & b ) const;
...
protected:
  ...
  inline HepBoostY (G4double beta, G4double gamma);
