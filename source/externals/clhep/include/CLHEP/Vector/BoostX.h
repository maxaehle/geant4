...
public:
  ...
  // Copy and move assignment operators.
         ...
         HepBoostX & set (G4double beta);
  inline HepBoostX       (G4double beta);
  ...
  inline G4double distance2( const HepBoostX & b ) const;
  ...
  inline G4double howNear(   const HepBoostX & b ) const;
...
protected:
  ...
  inline HepBoostX (G4double beta, G4double gamma);
