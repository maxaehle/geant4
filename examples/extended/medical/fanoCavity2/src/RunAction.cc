...
:fDetector(det),fKinematic(kin),fRun(0),fHistoManager(0)
{
...
{
  fRun = new Run(fDetector,fKinematic,isMaster);
  return fRun;
}
...
{    
  ...
  //G4double energyGun = fKinematic->GetParticleGun()->GetParticleEnergy();
