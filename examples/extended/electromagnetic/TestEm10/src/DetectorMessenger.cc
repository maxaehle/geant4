...
// ********************************************************************
//
/// \file electromagnetic/TestEm10/src/DetectorMessenger.cc
...
{ 
  ...
  fDetectorSetUpCmd->SetCandidates("simpleALICE alice06 bari05 harris73 watase86 barr90");
  fDetectorSetUpCmd->AvailableForStates(G4State_PreInit);
}
