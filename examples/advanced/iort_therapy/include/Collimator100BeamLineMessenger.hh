...
#ifndef Collimator100BeamLineMessenger_h
#define Collimator100BeamLineMessenger_h 1

#include "globals.hh"
#include "G4UImessenger.hh"

class Collimator100BeamLine;
class G4UIdirectory;
class G4UIcmdWithADoubleAndUnit;
class G4UIcmdWithAString;

class Collimator100BeamLineMessenger: public G4UImessenger
{
  public:
...
private:
  ...
  Collimator100BeamLine* collimator100;
